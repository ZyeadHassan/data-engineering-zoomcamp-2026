...
BUCKET_NAME = "dezoomcamp-hw3-2026-zyead"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = r"E:\DE Zoomcamp 2026\Module 3\project-f6a0efb4-f01f-4835-8ba-a9e3d3a5d36d.json"
...
def download_file(month):
    ...
    file_path = os.path.join(
        DOWNLOAD_DIR, f"yellow_tripdata_2024-{month}.parquet")
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        executor.map(upload_to_gcs, filter(
            None, file_paths))  # Remove None values
